...
/**
 * A supplier of objects with 5 parameters.
 */
@FunctionalInterface
public interface Supplier5<P1, P2, P3, P4, P5, T> {
   /**
    ...
    */
   default Supplier4<P2, P3, P4, P5, T> param(P1 p1) {
      return (p2, p3, p4, p5) -> get(p1, p2, p3, p4, p5);
   }
}
